...
\rhead{Lab 3.3: Multiprotocol Scheduling}
\cfoot{\thepage}

\title{\textbf{Lab 3.3: Multiprotocol Scheduling}\\
...
\begin{itemize}
    \item Understand Multiprotocol Scheduling concepts
...
This lab focuses on Multiprotocol Scheduling. Refer to Course 3 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 3.3.
...
Refer to Lab\_Solutions.md Section 3.3 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 3 - Lab 3.3}\\

...
\rhead{Lab 6.4: Production Optimization}
\cfoot{\thepage}

\title{\textbf{Lab 6.4: Production Optimization}\\
...
\begin{itemize}
    \item Understand Production Optimization concepts
...
This lab focuses on Production Optimization. Refer to Course 6 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 6.4.
...
Refer to Lab\_Solutions.md Section 6.4 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 6 - Lab 6.4}\\

...
\pagestyle{fancy}
\fancyhf{}
\lhead{USP Training Course 6}
\rhead{Lab 6.2: LoRaWAN Relay Configuration}
\cfoot{\thepage}

\title{\textbf{Lab 6.2: LoRaWAN Relay Configuration}\\
\large Course 6: Advanced Features}
...
\begin{itemize}
    \item Understand LoRaWAN Relay Configuration concepts
...
This lab focuses on LoRaWAN Relay Configuration. Refer to Course 6 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 6.2.
...
Refer to Lab\_Solutions.md Section 6.2 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 6 - Lab 6.2}\\

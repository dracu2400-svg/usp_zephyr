...
\rhead{Lab 2.5: LoRaWAN Relay TX}
\cfoot{\thepage}

\title{\textbf{Lab 2.5: LoRaWAN Relay TX}\\
...
\begin{itemize}
    \item Understand LoRaWAN Relay TX concepts
...
This lab focuses on LoRaWAN Relay TX. Refer to Course 2 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 2.5.
...
Refer to Lab\_Solutions.md Section 2.5 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 2 - Lab 2.5}\\

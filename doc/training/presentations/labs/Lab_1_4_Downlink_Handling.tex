...
\rhead{Lab 1.4: Downlink Handling}
\cfoot{\thepage}

\title{\textbf{Lab 1.4: Downlink Handling}\\
...
\begin{itemize}
    \item Understand Downlink Handling concepts
...
This lab focuses on Downlink Handling. Refer to Course 1 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 1.4.
...
Refer to Lab\_Solutions.md Section 1.4 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 1 - Lab 1.4}\\

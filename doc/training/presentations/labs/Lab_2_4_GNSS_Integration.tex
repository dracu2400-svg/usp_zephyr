...
\rhead{Lab 2.4: GNSS Integration}
\cfoot{\thepage}

\title{\textbf{Lab 2.4: GNSS Integration}\\
...
\begin{itemize}
    \item Understand GNSS Integration concepts
...
This lab focuses on GNSS Integration. Refer to Course 2 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 2.4.
...
Refer to Lab\_Solutions.md Section 2.4 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 2 - Lab 2.4}\\

...
\rhead{Lab 6.3: Certification Testing}
\cfoot{\thepage}

\title{\textbf{Lab 6.3: Certification Testing}\\
...
\begin{itemize}
    \item Understand Certification Testing concepts
...
This lab focuses on Certification Testing. Refer to Course 6 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 6.3.
...
Refer to Lab\_Solutions.md Section 6.3 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 6 - Lab 6.3}\\

...
\rhead{Lab 3.1: RAC Transaction Implementation}
\cfoot{\thepage}

\title{\textbf{Lab 3.1: RAC Transaction Implementation}\\
...
\begin{itemize}
    \item Understand RAC Transaction Implementation concepts
...
This lab focuses on RAC Transaction Implementation. Refer to Course 3 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 3.1.
...
Refer to Lab\_Solutions.md Section 3.1 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 3 - Lab 3.1}\\

...
\rhead{Lab 5.2: TX Power Calibration}
\cfoot{\thepage}

\title{\textbf{Lab 5.2: TX Power Calibration}\\
...
\begin{itemize}
    \item Understand TX Power Calibration concepts
...
This lab focuses on TX Power Calibration. Refer to Course 5 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 5.2.
...
Refer to Lab\_Solutions.md Section 5.2 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 5 - Lab 5.2}\\

...
\pagestyle{fancy}
\fancyhf{}
\lhead{USP Training Course 4}
\rhead{Lab 4.4: Multiprotocol Application}
\cfoot{\thepage}

\title{\textbf{Lab 4.4: Multiprotocol Application}\\
\large Course 4: Multiprotocol Development}
...
\begin{itemize}
    \item Understand Multiprotocol Application concepts
...
This lab focuses on Multiprotocol Application. Refer to Course 4 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 4.4.
...
Refer to Lab\_Solutions.md Section 4.4 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 4 - Lab 4.4}\\

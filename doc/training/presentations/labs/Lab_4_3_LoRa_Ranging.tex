...
\rhead{Lab 4.3: LoRa Ranging}
\cfoot{\thepage}

\title{\textbf{Lab 4.3: LoRa Ranging}\\
...
\begin{itemize}
    \item Understand LoRa Ranging concepts
...
This lab focuses on LoRa Ranging. Refer to Course 4 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 4.3.
...
Refer to Lab\_Solutions.md Section 4.3 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 4 - Lab 4.3}\\

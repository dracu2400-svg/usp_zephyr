...
\rhead{Lab 2.2: Custom Event Handlers}
\cfoot{\thepage}

\title{\textbf{Lab 2.2: Custom Event Handlers}\\
...
\begin{itemize}
    \item Understand Custom Event Handlers concepts
...
This lab focuses on Custom Event Handlers. Refer to Course 2 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 2.2.
...
Refer to Lab\_Solutions.md Section 2.2 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 2 - Lab 2.2}\\

...
\rhead{Lab 4.2: PER Testing}
\cfoot{\thepage}

\title{\textbf{Lab 4.2: PER Testing}\\
...
\begin{itemize}
    \item Understand PER Testing concepts
...
This lab focuses on PER Testing. Refer to Course 4 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 4.2.
...
Refer to Lab\_Solutions.md Section 4.2 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 4 - Lab 4.2}\\

...
\rhead{Lab 6.1: FUOTA Implementation}
\cfoot{\thepage}

\title{\textbf{Lab 6.1: FUOTA Implementation}\\
...
\begin{itemize}
    \item Understand FUOTA Implementation concepts
...
This lab focuses on FUOTA Implementation. Refer to Course 6 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 6.1.
...
Refer to Lab\_Solutions.md Section 6.1 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 6 - Lab 6.1}\\

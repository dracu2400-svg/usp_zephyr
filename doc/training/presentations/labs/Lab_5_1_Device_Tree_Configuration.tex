...
\pagestyle{fancy}
\fancyhf{}
\lhead{USP Training Course 5}
\rhead{Lab 5.1: Device Tree Configuration}
\cfoot{\thepage}

\title{\textbf{Lab 5.1: Device Tree Configuration}\\
\large Course 5: Hardware Integration}
...
\begin{itemize}
    \item Understand Device Tree Configuration concepts
...
This lab focuses on Device Tree Configuration. Refer to Course 5 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 5.1.
...
Refer to Lab\_Solutions.md Section 5.1 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 5 - Lab 5.1}\\

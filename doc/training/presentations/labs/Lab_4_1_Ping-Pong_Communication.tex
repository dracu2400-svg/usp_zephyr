...
\rhead{Lab 4.1: Ping-Pong Communication}
\cfoot{\thepage}

\title{\textbf{Lab 4.1: Ping-Pong Communication}\\
...
\begin{itemize}
    \item Understand Ping-Pong Communication concepts
...
This lab focuses on Ping-Pong Communication. Refer to Course 4 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 4.1.
...
Refer to Lab\_Solutions.md Section 4.1 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 4 - Lab 4.1}\\

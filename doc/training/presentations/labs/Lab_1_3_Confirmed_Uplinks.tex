...
\rhead{Lab 1.3: Confirmed Uplinks}
\cfoot{\thepage}

\title{\textbf{Lab 1.3: Confirmed Uplinks}\\
...
\begin{itemize}
    \item Understand Confirmed Uplinks concepts
...
This lab focuses on Confirmed Uplinks. Refer to Course 1 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 1.3.
...
Refer to Lab\_Solutions.md Section 1.3 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 1 - Lab 1.3}\\

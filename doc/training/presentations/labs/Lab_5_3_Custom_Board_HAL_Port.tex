...
\rhead{Lab 5.3: Custom Board HAL Port}
\cfoot{\thepage}

\title{\textbf{Lab 5.3: Custom Board HAL Port}\\
...
\begin{itemize}
    \item Understand Custom Board HAL Port concepts
...
This lab focuses on Custom Board HAL Port. Refer to Course 5 presentation for theoretical background.
...
\begin{solutionbox}
\textbf{Note:} Complete solution code is available in the Lab\_Solutions.md document, Section 5.3.
...
Refer to Lab\_Solutions.md Section 5.3 for expected serial console output.
...
\begin{center}
\textit{USP Training Course 5 - Lab 5.3}\\

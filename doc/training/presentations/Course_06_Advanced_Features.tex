...
\textbf{Documentation:}
\begin{itemize}
    \item LoRa Alliance Specifications: \url{https://lora-alliance.org/}
    \item LBM Documentation: \url{https://github.com/Lora-net/SWSD004}
    \item Zephyr RTOS Docs: \url{https://docs.zephyrproject.org/}
    \item MCUboot: \url{https://mcuboot.com/}
\end{itemize}
...
\textbf{Certification:}
\begin{itemize}
    \item LoRa Alliance Device Certification: \url{https://lora-alliance.org/certification/}
